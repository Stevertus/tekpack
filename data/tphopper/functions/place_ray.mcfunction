...
execute positioned ^ ^ ^0.5 if entity @s[tag=!mcscriptStop] if block ~ ~ ~ air if score raycast1 mcscript_raycast matches ..10 run function tphopper:place_ray
...
execute if score raycast1 mcscript_raycast matches ..10 if entity @s[tag=mcscriptStop] positioned ^ ^ ^-0.3 run execute if block ~ ~ ~ air run function tphopper:create
