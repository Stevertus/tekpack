#######
# Compiled from .//functions/genmain.mcscript
# to .//functions/genmain.mcfunction
#
# Generated by Minecraft Script for 1.13
######
execute unless block ~ ~ ~ furnace{Items:[{id:"minecraft:iron_pickaxe",Slot:0b}]} run clear @a[distance=..4] iron_pickaxe{CustomModelData:3390002,fromGen:1b}
execute unless block ~ ~ ~ furnace{Items:[{id:"minecraft:iron_pickaxe",Slot:0b}]} run replaceitem block ~ ~ ~ container.0 iron_pickaxe{CustomModelData:3390002,fromGen:1b,HideFlags:6,display:{Name:"{\"text\":\"\"}"}}
