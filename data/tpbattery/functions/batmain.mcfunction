#######
# Compiled from .//functions/batmain.mcscript
# to .//functions/batmain.mcfunction
#
...
execute positioned ~ ~1 ~ if entity @s[tag=tpBattAddUp] run scoreboard players add @s tpE 1
execute positioned ~ ~1 ~ if entity @s[tag=tpBattAddUp] positioned ~ ~-1 ~ run function tpbattery:items
execute positioned ~ ~1 ~ if entity @s[tag=tpBattAddUp] run scoreboard players remove @e[tag=tpCable,distance=..0.8,limit=1] tpE 1
execute positioned ~ ~1 ~ if entity @s[tag=tpBattAddUp] run scoreboard players reset @e[tag=tpCable,distance=..0.8,scores={tpE=..0}] tpE
execute positioned ~ ~1 ~ if entity @s[tag=tpBattAddUp] run tag @s remove tpBattAddUp
