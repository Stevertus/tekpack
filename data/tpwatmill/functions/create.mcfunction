...
execute align xyz run summon armor_stand ~0.5 ~-0.13 ~0.5 {Fire:32767,Small:1,Tags: [tpMill,tpMillBlade,tpNew,tpCableConnector],Invisible:1,Marker:1,NoGravity:1,ShowArms:1b,HandItems:[{id:"stone_hoe",tag:{Unbreakable:1b,Damage:8},Count:1b},{}],Pose:{RightArm:[23f,0f,0f]}}
...
execute as @e[tag=tpWatMill,tag=tpNew] at @s run replaceitem entity @s armor.head minecraft:carrot_on_a_stick{Unbreakable:1b,Damage:11}
